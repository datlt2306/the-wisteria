...
const Location = () => {
    return (
        <div className="bg-[#113354]">
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2 md:ml-[1%] ">
                <div className=" pt-[5%] lg:pl-[18%] max-w-[80%]" >
                    <div className="font-[var(--font-h2)] mb-[17px]" >
                        ...
                        <span className="text-[#fade8c] font-bold ">Chung cư The Wisteria </span> <span className="text-[14px] text-white"> toạ lạc tại đại lộ Bình Minh, khu thiết kế phong cách Nhật (trong quần thể dự án Hinode Royal Park), mặt quốc lộ 32 thuộc địa bàn 2 xã Kim Chung & Di Trạch, Hoài Đức, Hà Nội. Cách trung tâm Hà Nội chỉ 10 phút lái xe, …</span>
                        ...
                        <span className=" text-[14px] text-white " >– Trong thời gian tới, việc hoàn thành các tuyến đường dự kiến như quốc lộ 32, Tây Thăng Long, đường vành đai 3.5, tuyến đường sắt trên cao Nhổn – ga Hà Nội sẽ góp phần thay đổi diện mạo giao thông của khu vực, hứa hẹn trở thành trung tâm đô thị sôi động mới của Thủ đô…
                        </span>
                    </div>
